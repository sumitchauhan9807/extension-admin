...
function  AllChats() {
  ...
  return (
      ...
      <tbody>
        {allUsers.map((user)=>{
          return (
            ...
            */}
              <td className="px-6 py-4">
                <Link to={`/admin/editchat/${user.id}`}><UIBtn  text={'Edit'}></UIBtn></Link>
              </td> 
           </tr>
          )
        })}
   ...
   <br/>
    <div className="p4">
    <Link  to="/admin/addchat" type="button" className="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Add New Chats</Link>
